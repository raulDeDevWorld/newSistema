                    ...
                    <>
                        {userDB.solicitudes[item].estado == undefined && <tbody>
                            ...
                            <tr>
                                ...
                                <td><button type="button" class="btn btn-success" onClick={() => handlerModal(item, 'Enviar')}>Enviar/Guardar</button></td>
                                <td><button type="button" class="btn btn-danger" onClick={() => handlerModal(item, 'Devolver')}>Devolver/Guardar</button></td>
                            </tr>
                        </tbody>}
