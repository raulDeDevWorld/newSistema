        ...
        {success == 'Aprobado' && <Success>Aprobado</Success>}
            <table className="table h-100">
                ...
                {userDB && Object.keys(userDB.solicitudes).map((item, index) =>
                    <>
                     { userDB.solicitudes[item].estado &&  userDB.solicitudes[item].estado == 'Reprobado' && <tbody>
                            ...
                            <tr>
                                ...
                                <td><button type="button" class="btn btn-success" onClick={() => handlerModal(item, 'Aprobar')}>Aprobar</button></td>
                            </tr>
                        </tbody>}
